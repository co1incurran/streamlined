...
<tbody>
	...
	?>
			<tr>	
				<td><a href = "../profile/profile.php?customerid=<?php echo $customerid;?>&companyid=0 " class="name"><?php echo ucwords($results['first_name']).' '.ucwords($results['last_name']);?></a></td>
