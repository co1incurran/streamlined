								...
								<header class="panel-heading clearfix">
									 ...
									 <hgroup>';
										/*<a href="documentation/index.html" class="btn btn-default pull-right" rel="#overlay"><i class="fa fa-question-circle"></i></a>';*/
											 ...
											 <a id="add_contact" href="add_asset.php?url='.$url.'&customerid='.$customerid.'&companyid='.$companyid.'" class="btn btn-default profile_button" data-toggle="tooltip" title="Add Asset"><i class="fa fa-plus"></i><strong> Add Asset </strong></a></h2>';
